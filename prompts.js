...
If the memory involves specific NAMED entities, append :entity=Name/type pairs inside the bracket. Use the canonical roster label for every structured identity reference. Historical source-used names may remain in memory prose only when explicitly present in the cited source. Do not create separate people from case variants, short-name variants, or supplied historical aliases. Never treat two different canonical roster names as an exact-name match. People sharing a surname are not the same person: never merge parents, siblings, spouses, or relatives merely because they share a surname or relationship record. Do not output role placeholders such as supporting_character, side_character, character, person, or NPC as entity names. Do not output common-noun fragments such as "sides", "both sides", "parents", "people", or "others" as person entities. Check canonical roster spelling before creating a new person. Classify each as: character, place, object, faction, or concept. Do not tag generic nouns unless they have a specific name in the conversation. Omit this field if no named entities are relevant.
...
Output exactly three sections using these tags. Keep every field to one line. Write factually. Do not include conversational preamble, Markdown headings, confidence annotations inside relationship labels, or any text outside the three sections. Use exact canonical relationship labels:
